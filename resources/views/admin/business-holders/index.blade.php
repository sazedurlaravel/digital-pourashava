                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <a class="dropdown-item" href="{{ route('admin.card_print', $user->id) }}"> কার্ড প্রিন্ট  </a>
                                        {{-- <a class="dropdown-item" href="{{ route('admin.business_holders.card', $user) }}"> কার্ড </a> --}}
                                        @if (auth()->user()->hasRole('super_admin') && $user->card_no ==null)
                                        <a class="dropdown-item" href="{{ route('admin.business_holders.edit', $user->id) }}"> আপডেট কার্ড নং </a>
                                        @endif
                                    </div>
                                </div>
                            </td>
